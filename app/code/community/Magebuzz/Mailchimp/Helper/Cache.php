...
class Magebuzz_Mailchimp_Helper_Cache extends Mage_Core_Helper_Abstract {
   ...
   * @access protected
   */
  protected $_cacheableCommands = array('getAccountDetails', 'listInterestGroupings', 'listMemberActivity', 'listMemberInfo', 'listMergeVars', 'lists', 'listsForEmail');
   ...
   * @access protected
   */
  protected $_cacheTagId = array('listMemberInfo' => array('id', 'email_address'), 'listMemberActivity' => array('id', 'email_address'), 'listsForEmail' => array('email_address'),);
   ...
   * @access protected
   */
  protected $_cacheClearCallbacks = array('listUnsubscribe' => array('listMemberInfo', 'listMembers', 'listMemberActivity', 'listsForEmail', 'lists'), 'listSubscribe' => array('listMemberInfo', 'listMembers', 'listMemberActivity', 'listsForEmail', 'lists'), 'listUpdateMember' => array('listMemberInfo', 'listMembers', 'listMemberActivity', 'listsForEmail', 'lists'),);
